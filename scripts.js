...
//    if(imageName === "3d-building-5-ffcc00.svg") {
...
function markLawyerJobPosition() {
    ...
    // building images
    square1.children[0].children[0].src = "/images/3d-building-5-ffcc00.svg"
    square2.children[0].children[0].src = "/images/3d-building-4-ffcc00.svg"
    square3.children[0].children[0].src = "/images/3d-building-4-ffcc00.svg"
...
function clearLawyerJobPosition() {
    ...
    // building images
    square1.children[0].children[0].src = "/images/3d-building-5.svg"
    square2.children[0].children[0].src = "/images/3d-building-4.svg"
    square3.children[0].children[0].src = "/images/3d-building-4.svg"
}